...
public:
	...
	float getOrientedWindowWidth() {return ConvertDipsToPixels(m_orientedScreenSize.Width);};
	float getOrientedWindowHeight() {return ConvertDipsToPixels(m_orientedScreenSize.Height);};
